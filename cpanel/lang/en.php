...
$l['all']['copyright1'] = "Server Management, Reporting, Accounting and Billing</a>";
$l['all']['copyright2'] = "Copyright &copy; 2019</a> <br/>
<a href=\"http://canyonmicrosystems.co.ke\">Canyon Microsystems</a>.";
$l['all']['ID'] = "Account No.";
...
$l['all']['PlanActive'] = "Package Active";
$l['all']['PlanTimeType'] = "Package Time Type";
$l['all']['PlanTimeBank'] = "Package Time Bank";
$l['all']['PlanTimeRefillCost'] = "Package Refill Cost";
$l['all']['PlanTrafficRefillCost'] = "Package Refill Cost";
$l['all']['PlanBandwidthUp'] = "Package Bandwidth Up";
$l['all']['PlanBandwidthDown'] = "Package Bandwidth Down";
$l['all']['PlanTrafficTotal'] = "Package Traffic Total";
$l['all']['PlanTrafficDown'] = "Package Traffic Down";
$l['all']['PlanTrafficUp'] = "Package Traffic Up";
$l['all']['PlanRecurring'] = "Package Recurring";
$l['all']['PlanRecurringPeriod'] = "Package Recurring Period";
$l['all']['planRecurringBillingSchedule'] = "Package Recurring Billing Schedule";
$l['all']['PlanCost'] = "Package Cost";
$l['all']['PlanSetupCost'] = "Package Setup Cost";
$l['all']['PlanTax'] = "Package Tax";
$l['all']['PlanCurrency'] = "Package Currency";
$l['all']['PlanGroup'] = "Package Profile (Group)";
$l['all']['PlanType'] = "Package Type";
$l['all']['PlanName'] = "Package Name";
$l['all']['PlanId'] = "Package Id";

$l['all']['account'] = "Account #";
$l['all']['balance'] = "Account Balance";
$l['all']['username'] = "Username";
...
$l['Tooltip']['planTooltip'] = "Select a Package to associate the user with";
...
$l['Tooltip']['BillingPlanName'] = "Type the Billing Package name";
$l['Tooltip']['PlanName'] = "Type the Package name";
...
$l['Tooltip']['planNameTooltip'] = "The Package's name. This is<br/>
					a friendly name describing the
					characeristics of the Package";
...
$l['Tooltip']['BillingWalletName'] = "Edit Wallet";
...
$l['Tooltip']['reassignplanprofiles'] = "If toggled on, when applying user information <br/>
					...
					profiles will be re-assigned based on the Packages profile association";
...
$l['button']['locations'] = "User Location";
...
$l['button']['ListPlans'] = "List Packages";
$l['button']['NewPlan'] = "New Package";
$l['button']['EditPlan'] = "Edit Package";
$l['button']['RemovePlan'] = "Remove Package";

$l['button']['ListWallet'] = "List Wallet";
$l['button']['NewWallet'] = "New Wallet";
$l['button']['EditWallet'] = "Edit Wallet";
$l['button']['RemoveWallet'] = "Remove Wallet";
...
$l['button']['PlanUsage'] = "Package Usage";
...
$l['button']['ReAssignPlanProfiles'] = "Re-Assign Package Profiles";
...
$l['title']['walletInfo'] = "Wallet Information";
$l['title']['PlanInfo'] = "Package Information";
$l['title']['TimeSettings'] = "Time Settings";
$l['title']['BandwidthSettings'] = "Bandwidth Settings";
$l['title']['PlanRemoval'] = "Package Removal";
...
$l['ContactInfo']['PlanName'] = "Package Name";
...
$l['Intro']['acctplans.php'] = "Packages Accounting Page";
...
$l['Intro']['billplans.php'] = "Packages";
$l['Intro']['billplansdel.php'] = "Delete Package entry";
$l['Intro']['billplansedit.php'] = "Edit Package Details";
$l['Intro']['billplanslist.php'] = "Packages Table";
$l['Intro']['billplansnew.php'] = "New Package entry";

$l['Intro']['billwalletlist.php'] = "Wallet";
