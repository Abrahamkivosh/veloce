...
<body>
  ...
  <div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-signal"></i> Dashboard</a>
    <ul>
      ...
      <li class="active"> <a href="payments.php"><i class="icon icon-signal"></i> <span>My Payments</span></a> </li>
  ...
  <div id="content">
    ...
    $sqli = "SELECT * FROM mpesa_payments WHERE BillRefNumber = '$account' ORDER BY `Auto` DESC";
    $result6 = mysqli_query($con, $sqli);
    ?>
        ...
        <ul class="quick-actions">
          <table id="t01">
            ...
            while ($row = mysqli_fetch_array($result6)) {
              echo "<tr><td>" . date('M,d,Y H:i:s', strtotime($row['TransTime'])) . "</td>";
