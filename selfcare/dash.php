...
<div id="search">
  ...
  <div id="content">
    ...
    <div id="content-header">
      <div id="breadcrumb"> <a href="dash.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      </div>
    </div>
    <!--End-breadcrumbs-->
    ...
    <div class="container-fluid">
      <div class="quick-actions_homepage">
        <ul class="quick-actions">
          <li class="bg_lb"> <a href="#"> <span class="label label-important"></span>Name:</br>
              <?php echo strtoupper("<strong>" . $fName . "</br>" . $lName . "</strong>"); ?> </a> </li>
          <li class="<?php echo $remcol; ?>"> <a href="<?php echo $href; ?>" class="<?php echo $mdalcls; ?>"
              data-modal="<?php echo $datamd; ?>"><?php echo $reminder; ?></a> </li>
          <li class="bg_lg span3"> <a href="">Current Plan:</br> <?php echo strtoupper($plan); ?></br></a> </li>
          <li class="<?php echo $cls; ?>"> <a href="#"><span
                class="label label-success"><?php echo $days . "&nbspDays" ?></span><?php echo "Status:&nbsp" . $status; ?>
            </a> </li>
          <li class="bg_lo"> <a href="">Account
              Number:</br><?php echo strtoupper("<strong>" . $account . "</strong>"); ?></a> </li>
          <li class="bg_ls"> <a href="">Account
              Balance:</br></br><?php echo strtoupper("<strong>Ksh." . $balance . "</strong>"); ?></a> </li>

          <li class="bg_lo span3"> <a href="">Expiry
              Date:</br></br></i><?php echo ("<strong>" . $rexp . "</strong>"); ?></i></a> </li>
